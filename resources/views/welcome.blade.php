...
@section('title', 'One Point Solution')
@section('content')

    <aside class="hidden sm:flex sm:flex-col">
        <a href="#"
            class="inline-flex items-center justify-center h-20 w-20 bg-blue-600 hover:bg-blue-500 focus:bg-blue-500">
        ...
        <div class="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
            <nav class="flex flex-col mx-4 my-6 space-y-4">
                ...
                <a href="#" class="inline-flex items-center justify-center py-3 text-blue-600 bg-white rounded-lg">
